...
author: Dean Stamler
slug: AWS-Storage-Gateway-and-NTFS-permissions
categories:
  - IT
tags:
  - aws
  ...
  - smb
  - file sharing
description: AWS Storage Gateway can expose an S3 bucket as an SMB share, but
  permissions behaviour can be confusing. Here's an explanation.
---
